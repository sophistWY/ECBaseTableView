...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "sophistWY"
  # s.authors            = { "sophistWY" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/sophistWY"
  ...
  s.source_files  = "ECBaseTableView", "ECBaseTableView/Category/*.{h,m}"
